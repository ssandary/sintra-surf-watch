...
The app opens with a full-screen welcome while all six camera streams start in the background. The dashboard is fixed to the phone viewport and does not scroll. Selecting a beach opens a portrait viewer with live snapshot buttons for the other beaches and an optional landscape control.
